...
#import "VidyoVirtualWindowShare_Objc.h"
@class VCCall;
@class VCEndpoint;
...
@interface VCEndpoint : NSObject
{
	...
	-(BOOL) selectVirtualWindowShare:(VCVirtualWindowShare*)virtualWindowShare;
	...
	-(void) virtualWindowShareSelectAdvanced:(VCVirtualWindowShare*)virtualWindowShare;
	-(void) virtualWindowShareUnselectAdvanced:(VCVirtualWindowShare*)virtualWindowShare;
	-(id) initWithObject:(void*)rPtr;
	-(void*)getObjectPtr;
@end
...
@interface VCRoom : NSObject
{
	...
	-(void) addVirtualWindowShare:(VCVirtualWindowShare*)virtualWindowShare RemoveOthers:(BOOL)removeOthers;
	...
	-(void) removeVirtualWindowShare:(VCVirtualWindowShare*)virtualWindowShare;
