...
{function visibility="private":
	...
	{parameter: {name: w} {description: The VidyoVirtualWindowShare object. }}
	{parameter: {name: frameInterval} {description: Set as an override of minimum frame interval for discrete and bounds constraints. }}
	{return: }
}
*/
...
{function:
	...
	{parameter: {name: w} {description: }}
	{parameter: {name: maxFrameInterval} {description: Maximum time between frames in ns}}
	{parameter: {name: minFrameInterval} {description: Minimum time between frames in ns}}
...
/**
{function:
	{name: VidyoVirtualWindowShareSetDiscreteConstraints}
	{parent: VidyoVirtualWindowShare}
	{description: }
	{prototype: LmiBool VidyoVirtualWindowShareSetDiscreteConstraints(VidyoVirtualWindowShare* w, LmiTime maxFrameInterval, LmiTime minFrameInterval, LmiUint width, LmiUint height, LmiFloat32 scaleFactor)}
	{parameter: {name: w} {description: }}
	{parameter: {name: maxFrameInterval} {description: Maximum time between frames in ns}}
	{parameter: {name: minFrameInterval} {description: Minimum time between frames in ns}}
...
*/
LmiBool VidyoVirtualWindowShareSetDiscreteConstraints(VidyoVirtualWindowShare* w, LmiTime maxFrameInterval, LmiTime minFrameInterval, LmiUint width, LmiUint height, LmiFloat32 scaleFactor);
