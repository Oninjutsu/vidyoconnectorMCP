...
#include "VidyoVirtualWindowShare.h"
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Registers to get notified about local camera events. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Selects the local camera to use. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	 ...
	 {parent: VidyoConnector}
	 {description: Selects the local camera to use for video content share. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Assigns the view in which to show the preview from a local camera. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Registers to get notified about local microphone events. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Selects the local microphone to use. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	 ...
	 {parent: VidyoConnector}
	 {description: Selects the local microphone to use for audio content share. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Registers to get notified about local speaker events. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Selects the local speaker to use. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Registers to get notified about local monitor events. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Registers to get notified about local shareable-window events. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Sets the flag to show/hide the local camera preview for composite layout only. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Sets the flag to show/hide the local camera for remote participants for composite/custom layout and local camera preview for composite layout only. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Registers to get notified about remote microphone events. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Shows a VidyoRemoteWindowShare in a view. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Shows a VidyoVirtualVideoSource in a view. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Set the background color of the view. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Sets the speed of transition animation for windows moving around inside the view. On, iOS, this API must be called from main(UI) thread.}
...
{function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Disables connector object, releases all devices as precursor to destruct. On, iOS, this API must be called from main(UI) thread.}
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Sets the file that contains certificate authority's certificates used to authenticate a TLS connection.}
	{prototype: void VidyoConnectorSetCertificateAuthorityFile(VidyoConnector* c, const char* certificateAuthorityFile)}
	{parameter:
		{name: c}
		{description: The VidyoConnector object.}
	}
...
*/
void VidyoConnectorSetCertificateAuthorityFile(VidyoConnector* c, const char* certificateAuthorityFile);
...
{function apigroup="beta,enterprise":
 	...
 	{parent: VidyoConnector}
 	{description: Request to resume sending video after sever paused video stream from selected local camera. On, iOS, this API must be called from main(UI) thread.}
...
{function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Create virtual video source. The user can create a maximum of 10 virtual video sources. On, iOS, this API must be called from main(UI) thread.}
...
{function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Selects the virtual video source which is camera that will be shown to remote participants. The real camera will be unselected if it's selected. On, iOS, this API must be called from main(UI) thread.}
...
{function apigroup="connector":
    ...
    {prototype: LmiBool VidyoConnectorSelectVirtualSourceWindowShare(VidyoConnector* c, VidyoVirtualVideoSource* virtualWindowShare)}
    {parameter:
        {name: c}
        {description: The VidyoConnector object.}
    }
...
*/
LmiBool VidyoConnectorSelectVirtualSourceWindowShare(VidyoConnector* c, VidyoVirtualVideoSource* virtualWindowShare);
...
{function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Selects the local window to share in a conference. On, iOS, this API must be called from main(UI) thread.}
	{prototype: LmiBool VidyoConnectorSelectVirtualWindowShare(VidyoConnector* c, const VidyoVirtualWindowShare* virtualWindowShare)}
	{parameter:
		{name: c}
		{description: The VidyoConnector object.}
	}
	{parameter:
		{name: virtualWindowShare}
		{description: virtual window share to share in a conference. NULL if none of them should be shared.}
	}
	{return: LMI_TRUE on success, LMI_FALSE on failure.}
}
*/
LmiBool VidyoConnectorSelectVirtualWindowShare(VidyoConnector* c, const VidyoVirtualWindowShare* virtualWindowShare);
